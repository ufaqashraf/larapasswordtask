                ...
                columns: [
                    {
                        ...
                        template: function() {
	                      ...
	                      <a href="'+ userEditUrl+userId+'"><i class="fa fa-edit" id="'+ userId+'" onmouseover="editUser()" style="cursor: pointer;"></i></a>&nbsp;&nbsp;\
	                      <a href="'+ userRemoveUrl+userId+'"><i class="fa fa-trash" id="'+ userId+'" onmouseover="removeUser()" style="cursor: pointer;"></i></a>\
	                     ';

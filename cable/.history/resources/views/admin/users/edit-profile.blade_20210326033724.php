                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.edit-profile.update', $user->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="phone_number1" class="form-control" name="phone_number1" required
                                            autocomplete="phone_number1" autofocus>{{ $user->phone_number1 }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="phone_number2" class="form-control" name="phone_number2" required
                                            autocomplete="phone_number2" autofocus>{{ $user->phone_number }}</textarea>

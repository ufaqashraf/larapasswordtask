                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.edit-profile.update', $user->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" id="phone_number1" class="form-control" name="phone_number1"
                                            autocomplete="phone_number1" autofocus value="{{ $user->phone_number1 }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" id="phone_number2" class="form-control" name="phone_number2"
                                            autocomplete="phone_number2" autofocus value="{{ $user->phone_number2 }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="address" class="form-control" name="address" autocomplete="address"
                                ...
                                <div class="form-group row">
                                    <label for="remaining"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Remaining') }}</label>

                                    <div class="col-md-6">
                                        <input type="number" id="remaining" class="form-control" name="remaining"
                                            autocomplete="remaining" autofocus value="{{ $user->remaining }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" id="paid" class="form-control" name="paid" autocomplete="paid"
                                            autofocus value="{{ $user->paid }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select type="number" id="remaining" class="form-control" name="remaining">
                                        </select>
